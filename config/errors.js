...
module.exports = {
    errors: {
        ...
        NAME_ALREADY_EXITS: {
            response_code: "E_DEBLICATE_NAME",
        ...
        QUATATION_NOT_PRESENT: {
            response_code: "E_ENTITY_NOT_PRESENT",
            message: "Quatation is  not present",
            status: 401
        },
        SUPPLIER_NOT_PRESENT: {
            response_code: "E_ENTITY_NOT_PRESENT",
            message: "Supplier is not Available",
            status: 401
        },
        BUYER_NOT_PRESENT: {
            response_code: "E_ENTITY_NOT_PRESENT",
            message: "Buyer is not Available",
            status: 401
        },
        USER_NOT_PRESENT: {
            response_code: "E_ENTITY_NOT_PRESENT",
        ...
        QUATATION_PRESENT: {
            response_code: "E_ENTITY_PRESENT",
            message: "Quatation is  Already present",
            status: 401
        },
        SUPPLIER_PRESENT: {
            response_code: "E_ENTITY_PRESENT",
            message: "Supplier is Already Available",
            status: 401
        },
        BUYER_PRESENT: {
            response_code: "E_ENTITY_PRESENT",
            message: "Buyer is Already Available",
            status: 401
        },
        USER_PRESENT: {
            response_code: "E_ENTITY_PRESENT",
